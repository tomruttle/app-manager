...
export default function initReconcile(slots: SlotsMapType, fragments: FragmentsMapType, routes: RoutesMapType) {
  function getPageFragments(routeName: RouteNameType): PageFragmentsType {
    ...
    if (!pageFragments || typeof pageFragments !== 'object') {
      throw new AppManagerError(`SlotFinder returned invalid fragments for route ${routeName}`, {
        ...errData,
        level: levels.ERROR,
        code: 'get_fragments',
        recoverable: true,
