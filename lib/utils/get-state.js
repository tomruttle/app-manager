...
export default function initGetState(apps: AppsMapType, options: OptionsType) {
  return async function getState(url: string, prevApp: ?AppType, eventTitle?: mixed): Promise<?StateType> {
