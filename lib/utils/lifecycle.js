...
export default function initGetLifecycle(fragments: FragmentsMapType, slots: SlotsMapType, loadScript: (slotName: SlotNameType, fragmentName: FragmentNameType) => Promise<?ScriptType>, getSlotElement: GetSlotElementType, options: OptionsType) {
