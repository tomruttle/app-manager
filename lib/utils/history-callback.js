...
import type { EventsType, StateChangeType, BrowserStateType } from '../index';
...
type HistoryCallbackType = (state: BrowserStateType) => Promise<boolean>;
...
export default function iniHistoryCallback(w: Window) {
  ...
  function historyCallback(callback: HistoryCallbackType, events: EventsType) {
  ...
  historyCallback.eventTitles = eventTitles;
