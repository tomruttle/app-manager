...
export type UpdatePageType = (browserState: BrowserStateType, initialRender: boolean, onRecoverableError?: OnErrorCallbackType) => Promise<boolean>;
...
export default function initUpdatePage(reconcile: ReconcileType, createLifecycle: CreateLifecycleType, updateState: UpdateStateType, context: Context): UpdatePageType {
  ...
  return async function updatePage(browserState, initialRender, onRecoverableError) {
    const currentRoute = initialRender ? null : context.state.route;
