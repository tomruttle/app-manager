...
export type EventsType = {
  emit(eventTitle: EventTitleType, ...data: Array<any>): void,
  on(eventTitle: EventTitleType, callback: EventCallbackType): void,
  removeListener(eventTitle: EventTitleType, callback: EventCallbackType): void,
}
