...
import type { ConfigType, OverrideOptionsType, ContextType, StateWithAdditionsType } from './index.js.flow';
...
export default function initAppManager(w: Window) {
  function appManager(config: ConfigType, events: EventsType, overrideOptions?: OverrideOptionsType) {
    ...
    const context: ContextType = new (class Context {
      _state: StateWithAdditionsType
