...
export default function initAppManager(w: Window) {
  return class AppManager implements AppManagerInterface {
    ...
    _loadScript = async (state: StateType, fragmentName: FragmentNameType) => {
    ...
    _updateStatus = async (script: ScriptType, state: StateType, statusDetails: StatusDetailsType) => {
      if (script.version === 3) {
        return;
      }
    ...
    _hydrate = async (script: ScriptType, state: StateType, fragmentName: FragmentNameType, slotElement: Element) => {
    ...
    _render = async (script: ScriptType, state: StateType, fragmentName: FragmentNameType, slotElement: Element) => {
      const source = 'render';
    ...
    _onStateChange = async (script: ScriptType, state: StateType, fragmentName: FragmentNameType) => {
    ...
    _unmount = async (script: ScriptType, state: StateType, fragmentName: FragmentNameType, slotElement: Element) => {
    ...
    _handleError = async (slotName: SlotNameType, err: AppManagerError) => {
    ...
    _mountSlot = async (slotName: SlotNameType, fragmentName: ?FragmentNameType, hydrate: boolean, state: StateType) => {
    ...
    _unmountSlot = async (slotName: SlotNameType, state: StateType) => {
