  ...
  return class AppManager {
    ...
    _hydrate = (appName: AppNameType) => async (resolvedFragment: ResolvedFragmentType): Promise<boolean> => {
      ...
      try {
        ...
        if (!slotElement) {
          this.constructor._triggerError('hydrate.missing_element', slot);
          return false;
        }

        if (typeof script.hydrate !== 'function') {
          this.constructor._triggerError('hydrate.invalid_script', name || appName);
          return false;
        }
        ...
        this.constructor._triggerError('hydrate.run_script', name, err);
        return false;
      }
    };
    ...
    _unmount = (appName: AppNameType) => async (resolvedFragment: ResolvedFragmentType): Promise<?boolean> => {
      ...
      try {
        ...
        if (!slotElement) {
          this.constructor._triggerError('unmount.missing', slot);
          return false;
        }

        if (typeof script.unmount !== 'function') {
          this.constructor._triggerError('unmount.invalid_script', name || appName);
          return false;
        }
        ...
        this.constructor._triggerError('unmount.error', name || appName, err);
        return false;
      }
    };
    ...
    _mount = (appName: AppNameType) => async (resolvedFragment: ResolvedFragmentType): Promise<boolean> => {
      ...
      try {
        ...
        if (!slotElement) {
          this.constructor._triggerError('mount.missing', name || appName);
          return false;
        }

        if (typeof script.mount !== 'function') {
          this.constructor._triggerError('mount.invalid_script', name || appName);
          return false;
        }
        ...
        this.constructor._triggerError('mount.error', name || appName, err);
        return false;
      }
    };
    ...
    _onStateChange = (appName: AppNameType) => async (resolvedFragment: ResolvedFragmentType): Promise<boolean> => {
      ...
      try {
        if (typeof script.onStateChange !== 'function') {
          this.constructor._triggerError('on_state_change.invalid_script', name || appName);
          return false;
        }
        ...
        this.constructor._triggerError('on_state_change.error', name || appName, err);
        return false;
      }
    };
