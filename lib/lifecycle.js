...
export type CreateLifecycleType = (slotName: SlotNameType, fragmentName: FragmentNameType, onError: OnErrorCallbackType, initialRender: boolean) => LifecycleType;
...
export default function initCreateLifecycle(slots: SlotsMapType, getFragmentScript: GetFragmentScriptType, getSlotElement: GetSlotElementType, context: ContextType): CreateLifecycleType {
  return async function* createLifecycle(slotName, fragmentName, onError, initialRender) {
