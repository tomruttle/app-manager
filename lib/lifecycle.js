...
export type CreateLifecycleType = (container: Element, slotName: SlotNameType, fragmentName: FragmentNameType, onError: OnErrorCallbackType) => LifecycleType;
...
export default function initCreateLifecycle(slots: SlotsMapType, getFragmentScript: GetFragmentScriptType, getSlotElement: GetSlotElementType, context: Context): CreateLifecycleType {
  return async function* createLifecycle(container, slotName, fragmentName, onError) {
    const errData = {
      source: 'lifecycle',
